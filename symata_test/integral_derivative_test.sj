...
T (res == ConditionalExpression(Γ(1 + a), Re(a) > -1)) || (res == ConditionalExpression(Gamma(1 + a),(-Re(a)) < 1)) # For different versions of sympy
a = 1/2
T res == (1/2)*(Pi^(1/2))
a = -3/2
T res === Undefined
ClearAll(a)
T (res == ConditionalExpression(Gamma(1 + a), Re(a) > -1)) || (res == ConditionalExpression(Gamma(1 + a), (-Re(a)) < 1))
